#include "construction.hh"
 ...
 MyDetectorConstruction::MyDetectorConstruction()
 {
  //create a MESSENGER_Editor
   ...
   //comutare catre cutare ... scenariu geometric
  isCherenkov = true;
  isScintillator = true;
 }
 ...
 //construim Detectorul Cherenkov;
...
{
    solidScintillator = new G4Tubs("solidScintillator", 5*cm, 40*cm, 20*cm, 0*deg, 360*deg);

    logicScintillator = new G4LogicalVolume(solidScintillator, Germanium, "logicalScintillator");
    fScoringVolume = logicScintillator;

    physScintillator = new G4PVPlacement(0, G4ThreeVector(0.,0.,0.), logicScintillator, "physScintillator", logicWorld, false, 0, false);
